                        ...
                        <div class="card-body">
                            <div class="input-group mb-3">
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Masukan nama produk" value="{{ $product->name }}" autofocus="autofocus"
                                    required>
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="price" id="price"
                                    ...
                                    placeholder="Masukan harga" value="{{ $product->price }}" required>
                            ...
                            <img src="{{ asset('uploads/products/' . $product->thumbnail) }}" alt="Thumbnail"
                                width="200" />
                            ...
                            <div class="input-group mb-3">
                                <textarea id="description" name="description" class="form-control @if ($errors->has('description')) 'is-invalid' @endif"
                                    placeholder="Deskripsi produk" required>{{ $product->description }}</textarea>
...
@section('myjs')
    ...
    <script>
        ...
        function updateProduct() {
            let url = `{{ route('produk.update', $product->id) }}`;
